package com.example.labs.azimo.automationtestsupervisorexample.tests.function.register;
...
public class Register_Function_Tests {
    ...
    @Test
    public void testRegister_insertWrongEmail_shouldDisplayError() {
        ...
        onView(allOf(isAssignableFrom(AppCompatTextView.class), isDescendantOfA(withId(R.id.tilEmail))))
                .check(matches(withText(R.string.register_error_incorrect_email)));
    }

    @Test
    public void testRegister_whenEmailFieldIsEmpty_shouldDisplayError() {
        /** {@link RegisterActivity} */
        onView(withId(R.id.etEmail)).perform(clearText());
        onView(withId(R.id.btnRegister)).perform(click());

        onView(allOf(isAssignableFrom(AppCompatTextView.class), isDescendantOfA(withId(R.id.tilEmail))))
                .check(matches(withText(R.string.register_error_empty_email)));
    }
    ...
    public void testLogin_whenPasswordFieldIsEmpty_shouldDisplayError() {
        ...
        onView(allOf(isAssignableFrom(AppCompatTextView.class), isDescendantOfA(withId(R.id.tilPassword))))
                .check(matches(withText(R.string.register_error_empty_password)));
    }

    @Test
    public void testRegister_whenSwitchingFromRegisterToLogin_shouldKeepInsertedData() throws Exception {
